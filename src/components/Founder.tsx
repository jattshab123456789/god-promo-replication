      ...
      <div className="container px-4 relative z-10">
        <AnimatedSection variant="fade-up">
          <div className="text-center mb-12">
            <span className="text-primary text-sm font-semibold uppercase tracking-wider">Meet The Founder</span>
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2">The Mind Behind GOD PROMO</h2>
          </div>
        </AnimatedSection>
          ...
          <div className="card-glass p-8 md:p-12 rounded-3xl">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <AnimatedSection variant="slide-left" delay={0.2}>
                <div className="flex justify-center">
                  <div className="relative group">
                    <motion.div 
                      className="absolute inset-0 bg-primary/20 rounded-3xl blur-2xl transform scale-95"
                    ...
                    <img
                      ...
                      className="relative w-64 h-80 md:w-72 md:h-96 rounded-3xl object-cover border-2 border-primary/30 group-hover:border-primary/60 transition-all duration-300"
                    />
                  </div>
                </div>
              </AnimatedSection>
              ...
              <AnimatedSection variant="slide-right" delay={0.3}>
                <div>
                  <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-2">Sahil Grewal</h3>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Button className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold rounded-xl hover:scale-105 transition-transform" asChild>
                    ...
                    <Button variant="outline" className="border-primary/50 hover:bg-primary/10 text-foreground font-semibold rounded-xl hover:scale-105 transition-transform" asChild>
