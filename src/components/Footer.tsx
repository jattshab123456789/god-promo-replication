...
import { useContactInfo, useSiteContent } from "@/hooks/useSiteContent";
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href={`https://wa.me/${whatsapp}?text=Hello%2C%20I%27m%20interested%20in%20your%20services.`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-muted-foreground hover:text-foreground transition-colors">
